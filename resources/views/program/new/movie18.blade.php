	...
	<div class="col-md-12">
		...
		{{ csrf_field() }}
				...
				<label class="form-label bold">Użyj gotowej zajawki</label>
							...
							<option value="http://{{ $program->domain }}/video/movie1.mp4">Film 1</option>
							<option value="http://{{ $program->domain }}/video/movie2.mp4">Film 2</option>
							<option value="http://{{ $program->domain }}/video/movie3.mp4">Film 3</option>
							<option value="http://{{ $program->domain }}/video/movie4.mp4">Film 4</option>
							<option value="http://{{ $program->domain }}/video/movie5.mp4">Film 5</option>
						</select>
				</div>	
				</div>
				</div>
