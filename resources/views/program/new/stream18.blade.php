		...
		{{ csrf_field() }}
				...
				<label class="form-label bold">Użyj gotowej zajawki</label>
					<select class="form-control select2" id="defaultVideo">
							...
							<option value="http://{{ $program->domain }}/video/webcam1.mp4">Webcam 1</option>
							<option value="http://{{ $program->domain }}/video/webcam2.mp4">Webcam 2</option>
							<option value="http://{{ $program->domain }}/video/webcam3.mp4">Webcam 3</option>
							<option value="http://{{ $program->domain }}/video/webcam4.mp4">Webcam 4</option>
							<option value="http://{{ $program->domain }}/video/webcam5.mp4">Webcam 5</option>
						</select>
				</div>	
				</div>
				</div>
